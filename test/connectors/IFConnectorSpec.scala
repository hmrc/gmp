  ...
  "The IF Connector" must {
    ...
    "calculate" must {
      ...
      "return a calculation request" in {
        ...
        val result =
          TestIfConnector.calculate("PSAID", CalculationRequest("S1234567T", Nino("AB123456C"), "Bixby", "Bill", Some(0), None, Some(1), None, None, None))
      ...
      "trims whitespace from names" in {
        val urlCaptor: ArgumentCaptor[URL] = ArgumentCaptor.forClass(classOf[URL])
        requestBuilderExecute[HttpResponse](Future.successful(HttpResponse(200, calcResponseJson.toString(), returnHeaders)))
        TestIfConnector.calculate("PSAID", CalculationRequest("S1401234Q", Nino("CB433298A"), "LE BON", "Bill", Some(0), None, None, None, None, None))
      ...
      "generate correct url when names contains special char" in {
        ...
        val urlCaptor: ArgumentCaptor[URL] = ArgumentCaptor.forClass(classOf[URL])
        requestBuilderExecute[HttpResponse](Future.successful(HttpResponse(200, calcResponseJson.toString(), returnHeaders)))
        TestIfConnector.calculate("PSAID", CalculationRequest("S1401234Q", Nino("CB433298A"), "O'Smith", "Bill", Some(0), None, None, None, None, None))
      ...
      "generate correct url with revalrate" in {
        ...
        val urlCaptor: ArgumentCaptor[URL] = ArgumentCaptor.forClass(classOf[URL])
        requestBuilderExecute[HttpResponse](Future.successful(HttpResponse(200, calcResponseJson.toString(), returnHeaders)))
        TestIfConnector.calculate("PSAID", CalculationRequest("s1401234q", Nino("CB433298A"), "Smith", "Bill", Some(1), None, Some(1), None, None, None))
      ...
      "generate correct url with contribution and earnings" in {
        ...
        val urlCaptor: ArgumentCaptor[URL] = ArgumentCaptor.forClass(classOf[URL])
        requestBuilderExecute[HttpResponse](Future.successful(HttpResponse(200, calcResponseJson.toString(), returnHeaders)))
        TestIfConnector.calculate("PSAID", CalculationRequest("s1401234q", Nino("CB433298A"), "Smith", "Bill", Some(1), None, Some(1), Some(1), None, None))
